...
namespace TPProto{
    ...
    */
    ResourceTypesList::ResourceTypesList() : IdSequence(){
    }
    ...
    */
    ...
    /*! \brief Unpack from a Buffer.
        Unpacks the ResourceTypesList frame from the buffer.
    \param buf The Buffer to unpack out of.
    \return True if sucessful, false otherwise.
    */
    bool ResourceTypesList::unpackBuffer(Buffer *buf){
        IdSequence::unpackBuffer(buf);
        type = ft03_ResourceTypes;
        return true;
    }
