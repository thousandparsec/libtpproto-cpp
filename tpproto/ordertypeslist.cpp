...
namespace TPProto{
    ...
    */
    OrderTypesList::OrderTypesList() : IdSequence(){
    }
    ...
    */
    ...
    /*! \brief Unpack from a Buffer.
        Unpacks the OrderTypesList frame from the buffer.
    \param buf The Buffer to unpack out of.
    \return True if sucessful, false otherwise.
    */
    bool OrderTypesList::unpackBuffer(Buffer *buf){
        IdSequence::unpackBuffer(buf);
        type = ft03_OrderTypes;
        return true;
    }
