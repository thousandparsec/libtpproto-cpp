...
namespace TPProto{
    ...
    */
    ComponentIdsList::ComponentIdsList() : IdSequence(){
    }
    ...
    */
    ...
    /*! \brief Unpack from a Buffer.
        Unpacks the ComponentIdsList frame from the buffer.
    \param buf The Buffer to unpack out of.
    \return True if sucessful, false otherwise.
    */
    bool ComponentIdsList::unpackBuffer(Buffer *buf){
        IdSequence::unpackBuffer(buf);
        type = ft03_ComponentIds;
        return true;
    }
